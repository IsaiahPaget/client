...
function CaseStudyCards(props) {
	const Cards = (props) => {
		return projects.map((project) => {
			return (
				<article className=" dark:text-white flex relative flex-col shadow-lg card-trick p-3 rounded-lg bg-gradient-to-r from-whitesmoke to-white dark:from-tertiary dark:to-gray-dark hover:-translate-y-3 duration-700">
					<header className="">
	...
	return (
		<div>
			...
			<section className="flex p-8 justify-center card-list overflow-x-scroll">
				<Cards />
			</section>
		</div>
	);
